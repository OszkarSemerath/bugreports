 ...
 * @generated
 */
public class ExamplePackageSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ExamplePackagePackage.SWITCH: {
				examplePackage.Switch switch_ = (examplePackage.Switch)theEObject;
				T result = caseSwitch(switch_);
				if (result == null) result = caseTrackElement(switch_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExamplePackagePackage.MODEL: {
				Model model = (Model)theEObject;
				T result = caseModel(model);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExamplePackagePackage.RAILWAY_SYSTEM: {
				RailwaySystem railwaySystem = (RailwaySystem)theEObject;
				T result = caseRailwaySystem(railwaySystem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseSwitch(examplePackage.Switch object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Railway System</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Railway System</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRailwaySystem(RailwaySystem object) {
		return null;
	}
